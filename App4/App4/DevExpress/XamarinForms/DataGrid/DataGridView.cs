...
namespace DevExpress.XamarinForms.DataGrid
{
    ...
    public class DataGridView : View, IDataControllerOwner, ICustomCellTextProvider, IGridControlTest, IGridDataProvider, IStyledElement, IElementConfiguration<DataGridView>
    {
        ...
        private readonly Lazy<PlatformConfigurationRegistry<DataGridView>> _platformConfigurationRegistry;
        ...
        public DataGridView()
        {
            this._platformConfigurationRegistry = new Lazy<PlatformConfigurationRegistry<DataGridView>>(() => new PlatformConfigurationRegistry<DataGridView>(this));
            this.IsLoaded = false;
        ...
        public IPlatformElementConfiguration<T, DataGridView> On<T>() where T : IConfigPlatform
        {
            return this._platformConfigurationRegistry.Value.On<T>();
        }
