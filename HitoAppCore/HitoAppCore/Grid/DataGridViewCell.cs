				...
				if (col.CellTemplate != null)
				{
					...
					if (col.FieldName != null)
					{
						cell.SetBinding(BindingContextProperty,
							new Binding(col.FieldName, source: RowContext));
					}
				}
				else
				{
					...
					text.SetBinding(Label.TextProperty, new Binding(col.FieldName, BindingMode.Default, stringFormat: col.StringFormat));
